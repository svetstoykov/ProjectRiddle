...
/// </summary>
public sealed class AdminRiddlesServiceTests
{
    ...
    public async Task CreateCreatesADraftRiddle()
    {
        ...
        var result = await workspace.AdminService.CreateAsync(TestWorkspace.CreateRiddleInput(), CancellationToken.None);
    ...
    public async Task InvalidRangeIsRejected()
    {
        ...
        var result = await workspace.AdminService.CreateAsync(input, CancellationToken.None);
    ...
    public async Task LegalPublicationTransitionsWork()
    {
        ...
        var unpublished = await workspace.AdminService.UnpublishAsync(id, CancellationToken.None);
    ...
    {
        var workspace = new TestWorkspace(NoonUtcOnTwentieth);
        var first = await workspace.AdminService.CreateAsync(TestWorkspace.CreateRiddleInput(), CancellationToken.None);
        var second = await workspace.AdminService.CreateAsync(
        ...
        var scheduled = await workspace.AdminService.ScheduleAsync(
            ...
            CancellationToken.None);
        var conflict = await workspace.AdminService.ScheduleAsync(
        ...
        var unpublished = await workspace.AdminService.UnpublishAsync(first.Value.Id, CancellationToken.None);
        var reused = await workspace.AdminService.ScheduleAsync(
            new ScheduleRiddleInput(second.Value.Id, date),
            CancellationToken.None);
    ...
    public async Task DeleteIsNotPermittedForScheduledOrPublishedRiddles()
    {
        ...
        var scheduled = await workspace.AdminService.ScheduleAsync(
            ...
            CancellationToken.None);
        var deleted = await workspace.AdminService.DeleteAsync(created.Value.Id, CancellationToken.None);
    ...
    public async Task SofiaDateBoundaryControlsScheduling()
    {
        ...
        var created = await workspace.AdminService.CreateAsync(TestWorkspace.CreateRiddleInput(), CancellationToken.None);
        var scheduledToday = await workspace.AdminService.ScheduleAsync(
        ...
        var another = await workspace.AdminService.CreateAsync(
            TestWorkspace.CreateRiddleInput(clue: "втора бяла врана лети"),
            CancellationToken.None);
        var scheduledYesterday = await workspace.AdminService.ScheduleAsync(
