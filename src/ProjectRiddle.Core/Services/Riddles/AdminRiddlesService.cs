...
/// <summary>
/// Coordinates administrative riddle authoring, range validation, and publication transitions.
/// </summary>
public sealed class AdminRiddlesService : IAdminRiddlesService
{
    private readonly IRiddleRepository _riddleRepository;
    private readonly IDateTimeProvider _dateTimeProvider;
    private readonly ILogger<AdminRiddlesService> _logger;

    /// <summary>
    /// Initializes the administrative riddles service.
    /// </summary>
    ...
    public AdminRiddlesService(
        IRiddleRepository riddleRepository,
        IDateTimeProvider dateTimeProvider,
        ILogger<AdminRiddlesService> logger)
    {
